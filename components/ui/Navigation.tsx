      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link
              href="/signup"
              className="text-white font-semibold px-6 py-2.5 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 inline-flex items-center space-x-2"
              style={{
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 shadow-lg">
            <div className="px-4 py-6 space-y-4">
              <a
                href="#about"
                className="block text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white font-medium py-2"
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-slate-700 space-y-3">
                ...
                <Link
                  href="/signup"
                  className="block text-white font-semibold py-3 rounded-xl text-center"
                  style={{
                    backgroundColor: seasonalColors.primary,
                  }}
                  onClick={() => setMobileMenuOpen(false)}
